...
## 8.0.0: Drop support for TYPO3 11LTS and PHP < 8.1

### Changed

- Configure DI via attributes (#1297)
- Require Fluid >= 2.15.0 (#1282)
- Use PHP 8.1 language features (#1264, #1265, #1266, #1268, #1270)

### Removed

- Stop returning the password in `generateAndSetPasswordForUser()` (#1291)
- Drop support for TYPO3 11LTS (#1255, #1256, #1257, #1258, #1273)
- Drop support for PHP < 8.1 (#1253, #1254, #1259, #1263, #1267)
